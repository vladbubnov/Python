...
print(result_s_root_1, '======', result_s_root_2)
...
print(result_m_s_root_1, '=======', result_m_s_root_2)
...
result_mp_s_root_1 = math.pow(item_1, 0.5)
result_mp_s_root_2 = math.pow(item_2, 0.5)

# 18. Вывести result_mp_s_root в консоль.

print(result_mp_s_root_1, '========', result_mp_s_root_2)
...
# 33. Создать переменную item_3 и присвоить ей целoе число.
