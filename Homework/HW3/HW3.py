...
if currency_converter:
    ...
    target_currency_1 = input('Выберите валюту (USD, EUR, UAH, CHR, RUB, BYN): ')
    target_currency = str.lower(target_currency_1)
    target_currency_amount = float(input('Введите количество: '))
    currency_result = 0
